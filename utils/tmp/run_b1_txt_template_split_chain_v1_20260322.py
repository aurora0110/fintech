...
SIGNAL_SCRIPT = ROOT / "utils" / "tmp" / "run_b1_txt_template_split_opt_v1_20260322.py"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="B1 文本分模板库相似度 + 近似反例增强整链总控")
    ...
    parser.add_argument("--topn-list", type=str, default="3,5,8")
...
def main() -> None:
    ...
    signal_dir = args.result_root / f"b1_txt_template_split_signal_v1_{kind}_{suffix}_{ts}"
    account_dir = args.result_root / f"b1_txt_template_split_account_v1_{kind}_{suffix}_{ts}"
    chain_dir = args.result_root / f"b1_txt_template_split_chain_v1_{kind}_{suffix}_{ts}"
