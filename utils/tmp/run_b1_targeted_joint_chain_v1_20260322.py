...
SIGNAL_SCRIPT = ROOT / "utils" / "tmp" / "run_b1_targeted_joint_opt_v1_20260322.py"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="B1 定向联合优化总控：先信号层，再账户层")
...
def main() -> None:
    ...
    signal_dir = args.result_root / f"b1_targeted_joint_signal_v1_{suffix}_{ts}"
    account_dir = args.result_root / f"b1_targeted_joint_account_v1_{suffix}_{ts}"
    chain_dir = args.result_root / f"b1_targeted_joint_chain_v1_{suffix}_{ts}"
