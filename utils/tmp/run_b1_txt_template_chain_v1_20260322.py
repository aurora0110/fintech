...
SIGNAL_SCRIPT = ROOT / "utils" / "tmp" / "run_b1_txt_template_opt_v1_20260322.py"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="B1 文本模板相似度整链总控")
...
def main() -> None:
    ...
    signal_dir = args.result_root / f"b1_txt_template_signal_v1_{suffix}_{ts}"
    account_dir = args.result_root / f"b1_txt_template_account_v1_{suffix}_{ts}"
    chain_dir = args.result_root / f"b1_txt_template_chain_v1_{suffix}_{ts}"
