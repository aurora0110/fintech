...
def cal_KDJ(data, days, m1, m2):
    ...
    for x in data_list:
        if float(x[1]) <= 0:
            j_listlow0.append(round(x, 3))
        if float(x[1]) <= -5:
            j_listlow5.append(round(x, 3))
        if float(x[1]) <= -8:
            j_listlow8.append(round(x, 3))
        if float(x[1]) <= -10:
            j_listlow10.append(round(x, 3))
        if float(x[1]) <= -15:
            j_listlow15.append(round(x, 3))
        if float(x[1]) <= -20:
            j_listlow20.append(round(x, 3))
        if float(x[1]) <= -25:
            j_listlow25.append(round(x, 3))
        if float(x[1]) >= 80:
            j_listhigh80.append(round(x, 3))
        if float(x[1]) >= 90:
            j_listhigh90.append(round(x, 3))
        if float(x[1]) >= 100:
            j_listhigh100.append(round(x, 3))
        if float(x[1]) >= 110:
            j_listhigh110.append(round(x, 3))
        if float(x[1]) >= 120:
            j_listhigh120.append(round(x, 3))
