...
def download_stock_data(symbol, type, start_date, end_date, adjust):
    ...
    try:
        if type == "stock":
            stock_data = ak.stock_zh_a_hist(symbol="000001", period="daily", start_date=start_date, end_date=end_date, adjust="qfq") # symbol=symbol, period="daily", start_date=start_date, end_date=end_date, adjust="qfq"
...
if __name__ == '__main__':
    ...
    '''
    download_stock_data("000001", "stock", "2023-01-01 09:32:00", "2023-01-31 09:32:00","qfq")
