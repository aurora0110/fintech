...
def download_stock_data(symbol, type, start_date, end_date, adjust):
    ...
    try:
        if type == "stock":
            stock_data = ak.stock_zh_a_hist_min_em(symbol=symbol, start_date=start_date, end_date=end_date, adjust=adjust) # symbol=symbol, period="daily", start_date=start_date, end_date=end_date, adjust="qfq"
...
if __name__ == '__main__':
    ...
    download_stock_data("sz000001", "stock", "2023-01-01 09:32:00", "2023-01-31 09:32:00","qfq")
