...
def batch_download_stock_data(symbol_list, max_workersq , start_date, end_date, adjust='qfq'):
    """
    批量获取股票最近N天的数据
...
if __name__ == '__main__':
    # 示例股票列表
    stock_symbols = ["000001", "600000", "000333", "600036", "000858", 
                    "601318", "600519", "000651", "600887", "000568"]
    s = config.all_stock_symbol_list
    
    # 批量下载
    start_time = time.time()
    all_stock_data = batch_download_stock_data(
