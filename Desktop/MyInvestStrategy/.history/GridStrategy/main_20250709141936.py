...
if __name__ == '__main__':
    ...
    print(f"💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗")
    print(f"策略信号：")
    print(f"当日满足J值小于-5的有{len(select_list_J)}个：{select_list_J}")
    print(f"当日满足J值小于-5，且最近连续{bbi_days}天的收盘价格大于bbi的有{len(select_list_JSBBI)}个：{select_list_JSBBI}")
    print(f"当日满足J值小于-5，且单针下20短期指标小于20且单针下20长期指标大于60的有{len(select_list_JS)}个：{select_list_JS}")
    print(f"当日满足J值小于-5，且单针下20短期指标小于20且单针下20长期指标大于60，且最近连续{bbi_days}天的收盘价格大于bbi的有{len(select_list_JSBBI)}个：{select_list_JSBBI}")
