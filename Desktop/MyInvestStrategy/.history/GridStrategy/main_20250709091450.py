...
if __name__ == '__main__':
    ...
    print(f"当日满足J值小于-5，最近连续10天的收盘价格大于bbi的有{len(select_list_JSBBI)}个：{select_list_JSBBI}")
    print(f"当日满足J值小于-5，单针下20短期指标小于20且单针下20长期指标大于60的有{len(select_list_JS)}个：{select_list_JS}")
    print(f"当日满足J值小于-5，单针下20短期指标小于20且单针下20长期指标大于60，最近连续10天的收盘价格大于bbi的有{len(select_list_JSBBI)}个：{select_list_JSBBI}")
