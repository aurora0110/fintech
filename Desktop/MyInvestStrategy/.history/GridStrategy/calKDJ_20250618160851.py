...
def cal_KDJ(data, days, m1, m2):
    ...
    j_listlow0 = [], j_listlow5 = [], j_listlow8 = [], j_listlow10 = []
    j_listhigh80 = [], j_listhigh90 = [], j_listhigh100 = [], j_listhigh110 = []
    ...
    for x in data_list:
        if float(x[1]) <= 0:
            ...
            j_listlow10.append(x)
        elif float(x[1]) >= 80:
            j_listhigh80.append(x)
        elif float(x[1]) >= 90:
            j_listhigh90.append(x)
        elif float(x[1]) >= 100:
            j_listhigh100.append(x)
        elif float(x[1]) >= 110:
            j_listhigh110.append(x)
    
    print(f'j值小于0:{j_listlow0}/nj值小于-5:{j_listlow5}/nj值小于-8:{j_listlow8}/nj值小于-10:{j_listlow10}/nj值大于80:{j_listhigh80}/nj值大于90:{j_listhigh90}/nj值大于100:{j_listhigh100}/nj值大于110:{j_listhigh110}')
