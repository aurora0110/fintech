...
if __name__ == '__main__':
    ...
    print(f"✅ETF当日满足J值小于-5️⃣的ETF有{len(select_list_J)}个：{select_list_J}，持有且大于9️⃣0️⃣的有{len(select_list_J_sell)}个：{select_list_J_sell}")
    ...
    print(f"✅STOCK当日满足J值小于-5️⃣的有{len(stock_select_list_J)}个：{stock_select_list_J}，持有且大于9️⃣0️⃣的有{len(stock_select_list_J_sell)}个：{stock_select_list_J_sell}")
