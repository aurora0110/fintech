...
class StockCalculator:
    ...
    def execute_transaction(self, date, price, shares):
        """执行买卖操作"""
        # 验证输入
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            price = input("请输入当前每股价格 (元): ")
            shares = input("请输入操作份数 (股): ")
            
            if calculator.execute_transaction(date, price, shares):
                print("操作成功!")
                calculator.show_status()
