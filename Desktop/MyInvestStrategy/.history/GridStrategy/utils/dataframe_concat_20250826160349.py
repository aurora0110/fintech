...
if __name__ == "__main__":
    # 指定你的data文件夹路径的实际
    data_folder = '/Users/lidongyang/Desktop/MyInvestStrategy/GridStrategy/data'
    stock_symbol_list = import_b2_data(data_folder)
    out_path = '/Users/lidongyang/Desktop/MyInvestStrategy/GridStrategy/b2data/merged_stocks.csv'
    # 执行合并
    merged_data = merge_stock_data(stock_symbol_list, data_folder, 'all_stocks_merged' + datetime.now().strftime("%Y%m%d") + '.csv')
