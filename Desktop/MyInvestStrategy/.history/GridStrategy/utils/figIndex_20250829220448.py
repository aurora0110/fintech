...
if __name__ == '__main__':
    ...
    lines2 = plt.plot(
        X, vecs2[0], X, vecs2[1], X, vecs2[2], X, vecs2[3], X, vecs2[4],
        X, vecs2[5], X, vecs2[6], X, vecs2[7], X, vecs2[8], X, vecs2[9],
        X, vecs2[10], X, vecs2[11],X, vecs2[12],X, vecs2[13],X, vecs2[14],X, vecs2[15],X, vecs2[16],X, vecs2[17],X, vecs2[18],X, vecs2[19],X, vecs2[20],
        linewidth=1.8
    )
      # 给每条线设置标签
