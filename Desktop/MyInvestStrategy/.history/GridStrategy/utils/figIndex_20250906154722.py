...
if __name__ == '__main__':
    ...
    # 纵轴刻度更细（按你的PE范围调整步长）
    set_smart_y_ticks(ax2, vecs_broad_index)  # <== 这一句替换你原来的 MultipleLocator(5.0)
    ...
    # 纵轴更细
    set_smart_y_ticks(ax4, vecs_broad_index)  # <== 这一句替换你原来的 MultipleLocator(5.0)
