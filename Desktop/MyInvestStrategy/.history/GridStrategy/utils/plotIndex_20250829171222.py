...
沪深300（上证000300）、上证180（上证000010）、深证100（深证399330）、科创50（上证000688）、创业板指（深证399006）、上证50（上证000016）、中证500（上证000905）、中证1000（上证000852）、恒生科技、恒生医疗、标普500；
行业我只关心：全指医药（上证000991）、全指金融（上证000992）、全指消费（上证000990）、中证环保（上证000827）、全指信息（上证000993）、中证医疗（399989）、食品饮料（上证000807）、中证红利（上证000922）、中证军工（399967）、中证传媒（深证399971）、中国互联
