...
沪深300、上证180、深证100、科创50、创业板指、上证50、中证500、恒生、标普500、十年国债市盈率、中证1000、日经225、恒生科技、恒生医疗、标普500；行业我只关心：全指医药、
全指金融、全指消费、中证环保、全指信息、养老产业、中证医疗、食品饮料、中证红利、中证军工、中证传媒、中国互联
