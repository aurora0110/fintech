...
if __name__ == "__main__":
    # 指定你的data文件夹路径的实际
    file_path = '/Users/lidongyang/Desktop/临时条件股20250826.csv'
    ...
    # 执行合并
    merged_data = merge_stock_data(stock_symbol_list, file_path, out_path + '/merged_stocks' + datetime.now().strftime("%Y%m%d") + '.csv')
