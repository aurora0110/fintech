...
if __name__ == "__main__":
    # 指定你的data文件夹路径的实际
    data_folder = '/Users/lidongyang/Desktop/临时条件股20250826.csv'
    ...
    stock_years_ago =  now - relativedelta(month=6) # 获取n年前的日期
    ...
    # 执行合并
    merged_data = merge_stock_data(stock_symbol_list, data_folder, out_path + '/merged_stocks' + datetime.now().strftime("%Y%m%d") + '.csv')
