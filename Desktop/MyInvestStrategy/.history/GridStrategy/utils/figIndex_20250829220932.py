...
if __name__ == '__main__':
    ...
    lines = plt.plot(
        ...
        X, vecs[5],X, vecs[6],X, vecs[7],X, vecs[8],X, vecs[9],
        linewidth=1.8
    )
    ...
    lines2 = plt.plot(
        x_vecs2[0], vecs2[0], x_vecs2[1], vecs2[1], x_vecs2[2], vecs2[2], x_vecs2[3], vecs2[3], x_vecs2[4], vecs2[4],
        x_vecs2[5], vecs2[5], x_vecs2[6], vecs2[6], x_vecs2[7], vecs2[7], x_vecs2[8], vecs2[8], x_vecs2[9], vecs2[9],
        x_vecs2[10], vecs2[10], x_vecs2[11], vecs2[11],x_vecs2[12], vecs2[12],x_vecs2[13], vecs2[13],x_vecs2[14], vecs2[14],x_vecs2[15], vecs2[15],x_vecs2[16], vecs2[16],x_vecs2[17], vecs2[17],x_vecs2[18], vecs2[18],x_vecs2[19], vecs2[19],x_vecs2[20], vecs2[20],
        linewidth=1.8
    )
      # 给每条线设置标签
