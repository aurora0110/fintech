...
# 从本地文件导入股票代码
def import_b2_data(code_path='/Users/lidongyang/Desktop/自选股202508214.csv'):
...
# 合并单独的股票数据到一个文件里
def merge_stock_data(stock_symbol_list, folder_path, output_file='/Users/lidongyang/Desktop/MyInvestStrategy/GridStrategy/b2data/merged_stocks.csv'):
    """
...
if __name__ == "__main__":
    # 指定你的data文件夹路径
    data_folder = '/Users/lidongyang/Desktop/MyInvestStrategy/GridStrategy/data'  # 修改为你的实际路径
