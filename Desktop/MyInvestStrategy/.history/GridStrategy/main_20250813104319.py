...
if __name__ == '__main__':
    ...
    for symbol in tqdm(stock_symbol_list):
        ...
        # 横盘且勾到负值
        if TRADEING_SIDEWAYS_boolean and J_boolean:
    ...
    print(f"✅买入信号STOCK当日满足横盘且单针的有{len(stock_select_list_TS)}个：{stock_select_list_TS}，满足横盘且勾到负值的有{len(stock_select_list_TJ)}个：{stock_select_list_TJ}")
