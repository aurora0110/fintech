...
def download_stock_data(symbol, type, start_date, end_date, adjust):
    ...
    try:
        if type == "stock":
            ...
            # stock_data = ak.stock_zh_a_hist_tx(symbol = "sz000001", start_date = "19000101", end_date = "20500101", adjust = "",timeout = None)
            stock_data = ak.stock_zh_a_hist(symbol= "000001",period= "daily",start_date= "19700101",end_date= "20500101",adjust= "",timeout = None)
...
if __name__ == '__main__':
    ...
    '''
    download_stock_data("sz000001", "stock", "20230101", "20230131","qfq")
