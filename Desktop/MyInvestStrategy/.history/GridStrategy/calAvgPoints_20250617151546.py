...
def public_calculate(file_path, years):
    ...
    pd.set_option('display.unicode.east_asian_width', True) # 设置输出格式
    pd.set_option('display.colheaders_justify', 'center') # 设置输出格式
    print(f'计算平均点结果：{result_df}')
    return result_df

if __name__ == '__main__':
    file_path = '/Users/lidongyang/Desktop/vscodePython/sh51030020250612.csv'
    x_years_avg_points(file_path, 2)