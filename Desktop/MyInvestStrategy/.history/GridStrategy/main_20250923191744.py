...
if __name__ == '__main__':
    ...
    for symbol in tqdm(new_etf_symbol_list):
        ...
        # 画图
        if figSwitch:
            analyzer.plot_all(data_ma, data_bbi, data_price, data_macd, data_kdj, data_shakeout, code, windows=[20, 30, 60, 120])
        ...
        if data_kdj['J'].iloc[-1] >= 90 and code in holding_stock_codes:
            select_list_J_sell.append(code)
