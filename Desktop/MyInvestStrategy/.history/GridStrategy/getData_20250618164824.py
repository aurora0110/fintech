...
def download_stock_data(symbol, type, start_date, end_date, adjust):
    ...
    try:
        if type == "stock":
            stock_data = ak.stock_zh_a_spot_em(symbol=symbol, start_date=start_date, end_date=end_date, adjust=adjust) # symbol=symbol, period="daily", start_date=start_date, end_date=end_date, adjust="qfq"
