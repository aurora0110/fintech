...
if __name__ == '__main__':
    ...
    for symbol in symbol_list:
        ...
        data_back = bt.backTest(data_input, 200000, 1, 10, '2024-06-12', '2025-06-12')
        if data_back['avg_profit'] > 0.05:
            well_list.append([symbol, f"{round(data_back['avg_profit'],3)}%"])
        else:
            ordinary_list.append([symbol, f"{round(data_back['avg_profit'],3)}%"])
        print('***********' * 10)
