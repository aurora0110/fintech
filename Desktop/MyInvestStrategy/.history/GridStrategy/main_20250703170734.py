...
if __name__ == '__main__':
    ...
    for symbol in etf_symbol_list:
        ...
        backtest_log_path = backtest_log_path + symbol + ".txt"
        # 读取数据
        print(f"读取文件：{file_path}，回测结果保存路径：{backtest_log_path}")
        ...
        data_back = bt.backTest(data_input, amount, ineterval_days, total_shares, each_buy_shares, etf_start_date, end_date, backtest_log_path)
