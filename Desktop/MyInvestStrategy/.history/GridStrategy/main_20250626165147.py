...
if __name__ == '__main__':
    ...
    for symbol in symbol_list:
        ...
        print(f'{data.iloc[-1]["日期"]}-{data.iloc[0]["日期"]}\nj值小于等于0:{len(data_kdj[0])}\nj值小于等于-5:{len(data_kdj[1])}\nj值小于等于-8:{len(data_kdj[2])}\nj值小于等于-10:{len(data_kdj[3])}\nj值小于等于-15:{len(data_kdj[4])}\nj值小于等于-20:{len(data_kdj[5])}\nj值小于等于-25:{len(data_kdj[6])}\nj值大于等于80:{len(data_kdj[7])}\nj值大于等于90:{len(data_kdj[8])}\nj值大于等于100:{len(data_kdj[9])}\nj值大于等于110:{len(data_kdj[10])}\nj值大于等于120:{len(data_kdj[11])}')
