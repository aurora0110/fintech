...
if __name__ == '__main__':
    ...
    print(f"ETF回测策略年化收益大于10%有{len(stock_well_list)}个：{stock_well_list}，分别为：{stock_well_list}")
    print(f"ETF回测策略年化收益小于10%有{len(stock_ordinary_list)}个：{stock_ordinary_list}，分别为：{stock_ordinary_list}")
    print(f"💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗💗")
    print(f"ETF策略信号：")
    print(f"ETF当日满足J值小于-5的有{len(stock_select_list_J)}个：{stock_select_list_J}")
    print(f"ETF当日满足J值小于-5，且最近连续{bbi_days}天的收盘价格大于bbi的有{len(stock_select_list_JSBBI)}个：{stock_select_list_JSBBI}")
    print(f"ETF当日满足J值小于-5，且单针下20短期指标小于20且单针下20长期指标大于60的有{len(stock_select_list_JS)}个：{stock_select_list_JS}")
    print(f"ETF当日满足J值小于-5，且单针下20短期指标小于20且单针下20长期指标大于60，且最近连续{bbi_days}天的收盘价格大于bbi的有{len(stock_select_list_JSBBI)}个：{stock_select_list_JSBBI}")
