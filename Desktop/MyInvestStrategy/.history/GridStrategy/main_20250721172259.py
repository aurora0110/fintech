...
if __name__ == '__main__':
    ...
    print(f"STOCK满足J值快速下降（3天内下降值>=50）的有{len(stock_fast_down_j_list)}个：{stock_fast_down_j_list}，满足连续出现洗盘信号的有{len(stock_2days_shakeout_list)}：{stock_2days_shakeout_list}，满足5天出现3次洗盘信号的有{len(stock_5days_shakeout_list)}：{stock_5days_shakeout_list}")